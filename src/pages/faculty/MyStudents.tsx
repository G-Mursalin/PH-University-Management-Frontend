...
} from "../../redux/features/faculty/facultyCourseApi";
...
// Modal
function AddMarksModal({ studentInfo }) {
  ...
  const handleSubmit = async (data) => {
    ...
    // Send Data To Server
    try {
      await addMark(studentMark).unwrap();
      toast.success("Marks Added Successfully", { id: toastId });
    } catch (error) {
